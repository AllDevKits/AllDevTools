...
function WordToPdf() {
  ...
  const handleDrop = (e) => {
    ...
    if (droppedFile && droppedFile.name.match(/\.(docx?|doc)$/i)) {
      ...
      setError('Please drop a Word document (.doc or .docx)');
    }
  };
  ...
  return (
    <div className="tool-page">
      <div className="tool-header">
        ...
        <p>Convert Word documents (.doc, .docx) to PDF format</p>
      </div>
      ...
      <div className="file-converter-container">
        ...
        >
          ...
          {file ? (
            ...
            <div className="drop-zone-content">
              ...
              <p>Drag & drop your Word document here</p>
        ...
        <div className="converter-info">
          ...
          <ul>
            ...
            <li>Extracts and converts text content</li>
