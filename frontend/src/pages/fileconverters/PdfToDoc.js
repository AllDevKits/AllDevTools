...
function PdfToDoc() {
  ...
  const createWordDocument = async (textContent) => {
    ...
    textContent.forEach((pageContent, index) => {
      ...
      // Add page content - split into paragraphs
  ...
  const convert = async () => {
    ...
    try {
      ...
      // Generate and download as .doc (actually .docx format but with .doc extension for compatibility)
  ...
  return (
    <div className="tool-page">
      <div className="tool-header">
        ...
        <p>Convert PDF documents to DOC format</p>
      </div>
      ...
      <div className="file-converter-container">
        ...
        <div className="converter-info">
          <h3>About PDF to DOC Conversion</h3>
          <ul>
            <li>Extracts text content from PDF files</li>
            <li>Creates compatible DOC format document</li>
